	...
	tt := map[string]struct {
		...
		"username claim given": {
			...
			config: &Config{
				...
				RedisServiceName:           defaultRedisServiceName,
				MariaDBServiceName:         defaultMariaDBServiceName,
				MariaDBDatabaseServiceName: defaultMariaDBDatabaseServiceName,
			},
			err: "",
		},
		...
		"custom service names given": {
			env: map[string]string{
				EnvServiceIDs:                 "1,2,3",
				EnvUsername:                   "user",
				EnvPassword:                   "pw",
				EnvNamespace:                  "test",
				EnvRedisServiceName:           "redis-test",
				EnvMariaDBServiceName:         "mariadb-test",
				EnvMariaDBDatabaseServiceName: "mariadb-database-test",
			},
			config: &Config{
				ServiceIDs:                 []string{"1", "2", "3"},
				...
				RedisServiceName:           "redis-test",
				MariaDBServiceName:         "mariadb-test",
				MariaDBDatabaseServiceName: "mariadb-database-test",
			},
		},
		"defaults configured": {
			env: map[string]string{
